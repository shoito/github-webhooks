...
gcloud functions deploy ${FUNCTION_NAME} \
  ...
  --set-secrets GITHUB_PRIVATE_KEY=projects/${PROJECT_ID}/secrets/GITHUB_PRIVATE_KEY:latest,GITHUB_WEBHOOK_SECRET=projects/${PROJECT_ID}/secrets/GITHUB_WEBHOOK_SECRET:latest
